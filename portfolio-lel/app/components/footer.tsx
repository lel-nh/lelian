...
export default function Footer() {
  ...
  return(
    <footer className="bg-gabor-yellow p-8 md:p-12 mt-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="text-center md:text-left">
          <p className="font-bold text-xl"> <a href="mailto:lelian.nahon@gmail.com?subject=Contact portfolio" className="hover:text-gabor-pink transition-colors">mail</a></p>
        </div>
